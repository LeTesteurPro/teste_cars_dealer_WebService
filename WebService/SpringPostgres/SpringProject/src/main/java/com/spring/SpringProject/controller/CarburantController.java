...
public class CarburantController {
    ...
    @Autowired
    private CarburantRepository service;
    ...
    @GetMapping("/{id}")
    public Carburant getById(@PathVariable int id) {
        return service.findById(id);
    }

    @PostMapping("/add")
    public String ajouterObjet(@ModelAttribute("nouvelleObjet") Carburant newObject) {
